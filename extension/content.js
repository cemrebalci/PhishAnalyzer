...
if (currentURL.startsWith('http') && !currentURL.includes('railway.app') && !currentURL.includes('vercel.app') && !currentURL.includes('localhost')) {
  ...
  .then(data => {
    ...
    warning.innerHTML = `
      ...
      ">
        ...
        ${isPhishing ? data.explanations.map(exp => 
